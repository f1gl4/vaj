...
const personObject = (firstname, lastname, age) => {
    return {firstname: firstname, lastname: lastname, age: age, yearOfBirth: 2025 - age};
};
...
const sortVehiclesByPrice = (vehicles) => {
    return vehicles.sort((first, second) => first.price - second.price);
};
